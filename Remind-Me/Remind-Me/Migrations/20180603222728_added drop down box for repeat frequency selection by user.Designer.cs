...
namespace RemindMe.Migrations
{
    ...
    [Migration("20180603222728_added drop down box for repeat frequency selection by user")]
    partial class addeddropdownboxforrepeatfrequencyselectionbyuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemindMe.Models.RecurringReminders", b =>
                {
                    ...
                    b.Property<int>("RecurringReminderRepeatFrequencyID");
            ...
            modelBuilder.Entity("RemindMe.Models.ReminderRepeatFrequency", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RemindMe.Models.RecurringReminders", b =>
                {
                    b.HasOne("RemindMe.Models.ReminderRepeatFrequency", "RepeatFrequencyName")
                        .WithMany("Reminders")
